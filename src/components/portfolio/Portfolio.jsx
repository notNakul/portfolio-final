    ...
    return (
        <section className="portfolio container section" id="portfolio">
            ...
            <div className="portfolio__filters">
                ...
                <span className={activeFilter === 5 ? 'portfolio__item portfolio__item-active' : 'portfolio__item'} onClick={() => { filterItems("AI"); setActiveFilter(5) }}>
                    AI
                </span>
                <span className={activeFilter === 6 ? 'portfolio__item portfolio__item-active' : 'portfolio__item'} onClick={() => { filterItems("ML"); setActiveFilter(6) }}>
                    ML
                </span>
            </div>
